...
try {
    ...
    # -- [4.5] Copy static assets to standalone directory ------------------
    # Required for output:'standalone' - Next.js does NOT auto-copy these.
    Write-Step "[4.5] Copying static assets to standalone directory..."
    ...
    Write-Host "Static assets copied to .next/standalone"
