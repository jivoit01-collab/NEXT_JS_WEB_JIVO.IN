...
export function CleanTreeSection({ data }: CleanTreeSectionProps) {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <m.section className="relative min-h-[58svh] overflow-hidden bg-[#28311e] sm:min-h-[62svh] md:min-h-[70svh] lg:h-[clamp(660px,52vw,860px)] lg:min-h-[660px] 2xl:h-[clamp(760px,50vw,960px)]">
        <SafeImage
