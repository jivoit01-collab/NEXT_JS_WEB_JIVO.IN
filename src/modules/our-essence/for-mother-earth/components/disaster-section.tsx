...
export function DisasterSection({ data }: DisasterSectionProps) {
  ...
  return (
    <section className="relative min-h-[58svh] overflow-hidden bg-[#201a11] sm:min-h-[62svh] md:min-h-[70svh] lg:h-[clamp(640px,50vw,840px)] lg:min-h-[640px] 2xl:h-[clamp(760px,48vw,940px)]">
      <SafeImage
