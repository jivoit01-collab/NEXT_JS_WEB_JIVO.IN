...
export function HumanitySection({ data }: HumanitySectionProps) {
  ...
  return (
    <section className="relative min-h-[700px] overflow-hidden bg-[#06110b] sm:min-h-[730px] md:min-h-[75svh] lg:min-h-[90svh] xl:min-h-dvh">
      ...
      <div className="relative z-10 flex min-h-[700px] px-4 pt-12 pb-80 sm:min-h-[730px] sm:px-6 sm:pt-14 sm:pb-80 md:min-h-[75svh] md:py-16 lg:min-h-[90svh] lg:items-start lg:px-8 lg:pt-28 lg:pb-20 xl:min-h-dvh xl:pt-32 2xl:px-20 2xl:pt-40 2xl:pb-28">
        <div className="w-full max-w-7xl 2xl:max-w-screen-2xl">
          <div className="max-w-[760px] min-w-0 2xl:max-w-[940px]">
            <h2 className="text-balance font-jost-extrabold text-3xl leading-tight text-white uppercase drop-shadow-[0_3px_14px_rgba(0,0,0,0.55)] sm:text-4xl lg:text-5xl 2xl:text-6xl">
              {title}
            </h2>
            <p className="mt-4 max-w-[520px] text-xs leading-relaxed text-pretty text-white/92 drop-shadow-[0_2px_10px_rgba(0,0,0,0.6)] sm:mt-5 sm:text-base md:text-[17px] lg:mt-6 2xl:mt-8 2xl:max-w-[640px] 2xl:text-xl">
              {description}
            </p>
          </div>
        </div>
