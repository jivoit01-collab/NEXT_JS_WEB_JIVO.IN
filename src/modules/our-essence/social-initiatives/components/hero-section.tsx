...
export function SocialInitiativesHeroSkeleton() {
  return (
    <section
      aria-hidden
      className="relative flex animate-pulse items-center overflow-hidden bg-[#060b08] lg:min-h-[100svh]"
    >
      <div className="absolute inset-0 bg-white/10" />
      <div className="absolute inset-0 bg-black/34" />
      <div className="relative z-10 mx-auto grid w-full max-w-[1500px] grid-rows-[minmax(0,1fr)_auto] px-5 pt-20 pb-8 sm:px-6 sm:pt-24 sm:pb-9 md:px-8 md:pt-28 md:pb-10 lg:min-h-[100svh] lg:px-[6vw] lg:pt-28 lg:pb-[clamp(3.5rem,7dvh,6.5rem)] 2xl:px-[5vw]">
        <div className="flex min-h-0 items-center justify-center lg:justify-end lg:pb-[clamp(1.5rem,5dvh,4.5rem)]">
