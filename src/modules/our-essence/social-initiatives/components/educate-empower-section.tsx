    ...
    >
      ...
      <LazyMotion features={domAnimation}>
        <m.div
          ...
          className="relative z-10 mx-auto flex max-w-none items-end px-[5vw] pt-20 pb-12 sm:px-[5.5vw] sm:pb-14 md:pb-16 lg:h-full lg:px-[4.5vw] lg:pt-0 lg:pb-[clamp(4.5rem,14dvh,8.5rem)] 2xl:px-[6vw]"
        >
          <m.div variants={revealItem} className="w-full max-w-[680px] 2xl:max-w-[820px]">
            <h2 className="font-jost-extrabold text-[clamp(1.75rem,3.15vw,4.25rem)] leading-[0.98] text-balance text-white uppercase drop-shadow-[0_3px_14px_rgba(0,0,0,0.42)]">
              {heading}
            </h2>
