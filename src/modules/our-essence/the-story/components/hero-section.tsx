...
export function TheStoryHero({ data }: Props) {
  ...
  return (
    <section className="relative flex min-h-[60vh] items-center overflow-hidden sm:min-h-[70vh] lg:min-h-screen">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-12 pt-18 sm:px-6 sm:pb-16 sm:pt-32 lg:px-11 lg:pb-24">
        <h1 className="font-jost-bold text-3xl uppercase  text-white sm:text-4xl sm:tracking-[0.2em] md:text-5xl lg:text-5xl">
          {heading}
        </h1>
        <p className="mt-3 max-w-2xl w-2/4 text-sm leading-relaxed text-white/90 sm:mt-4 sm:text-base md:text-lg lg:mt-6 lg:text-xl">
          {paragraph}
        </p>
      </div>
    </section>
