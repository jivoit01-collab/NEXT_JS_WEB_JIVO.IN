...
const FULL_IMAGE_SIZES = '(max-width: 768px) 100vw, (max-width: 1536px) 110vw, 1920px';
    ...
    <section className="relative min-h-[74svh] overflow-hidden bg-[#53643a] sm:min-h-[82svh] lg:min-h-[100svh]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[72svh] w-full max-w-7xl items-start px-4 py-12 text-white sm:min-h-[82svh] sm:px-6 sm:py-14 lg:min-h-[100svh] lg:py-16 2xl:max-w-screen-2xl 2xl:px-20 2xl:pt-20">
        ...
        >
          <motion.h2
            variants={revealItem}
            className="font-jost-extrabold text-3xl leading-[0.98] text-balance drop-shadow-[0_4px_18px_rgba(0,0,0,0.55)] sm:text-4xl lg:text-[clamp(2rem,3.4vw,4rem)]"
          >
            {section.title}
          </motion.h2>
          <motion.p
            variants={revealItem}
            className="mt-5 max-w-[840px] whitespace-pre-line text-sm leading-relaxed text-pretty text-white/94 drop-shadow-[0_3px_12px_rgba(0,0,0,0.5)] sm:text-base 2xl:text-xl"
          >
            {section.description}
          </motion.p>
        </motion.div>
...
export function FreshLockSection({ data }: FreshLockSectionProps) {
  ...
  return (
    <section className="relative min-h-[78svh] overflow-hidden bg-[#a8b797] sm:min-h-[86svh] lg:min-h-[100svh]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[78svh] w-full max-w-7xl items-start px-4 pt-12 pb-52 sm:min-h-[86svh] sm:px-6 sm:pt-14 sm:pb-56 lg:min-h-[100svh] lg:items-center lg:py-16 2xl:max-w-screen-2xl 2xl:px-20 2xl:py-36">
        ...
        >
          <motion.h2
            variants={revealItem}
            className="font-jost-extrabold text-2xl leading-[1.06] text-balance drop-shadow-[0_3px_12px_rgba(63,78,52,0.38)] sm:text-3xl lg:text-[clamp(2rem,3.35vw,4rem)]"
          >
            {section.title}
          </motion.h2>
          <motion.p
            variants={revealItem}
            className="mt-5 max-w-[800px] whitespace-pre-line text-xs leading-relaxed text-pretty text-white/96 drop-shadow-[0_2px_10px_rgba(63,78,52,0.34)] sm:mt-6 sm:text-sm lg:mt-7 lg:text-base 2xl:text-xl"
          >
            {section.description}
          </motion.p>
        </motion.div>
