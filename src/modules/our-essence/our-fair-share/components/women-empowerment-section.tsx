  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="relative z-10 flex min-h-[60svh] w-full items-center justify-center px-5 py-12 text-center sm:min-h-[64svh] sm:px-6 md:min-h-[70svh] lg:h-full lg:min-h-0 lg:items-start lg:justify-end lg:px-0 lg:pt-[clamp(3.25rem,5vw,4.6rem)] lg:pr-[5vw]">
          <m.div
            variants={revealContainer}
            style={{ willChange: prefersReducedMotion ? 'auto' : 'transform, opacity' }}
            className="w-full max-w-[560px] min-w-0 transform-gpu text-center text-white lg:w-[46vw] lg:max-w-[630px]"
          >
            <m.h2
              variants={revealItem}
              className="font-jost-extrabold text-[clamp(1.9rem,4vw,2.8rem)] leading-[1.04] tracking-[0.02em] text-balance text-white uppercase drop-shadow-[0_3px_14px_rgba(0,0,0,0.4)]"
            >
              {title}
            </m.h2>
            <m.p
              variants={revealItem}
              className="font-jost-medium mt-2 text-[clamp(0.66rem,0.82vw,0.78rem)] tracking-[0.18em] text-white/90 uppercase sm:mt-3 lg:tracking-[0.2em]"
            >
              {subtitle}
            </m.p>
            <m.p
              variants={revealItem}
              className="mx-auto mt-4 max-w-[590px] text-[clamp(0.92rem,0.98vw,1rem)] leading-relaxed text-pretty text-white/90 drop-shadow-[0_2px_10px_rgba(0,0,0,0.34)]"
            >
              {description}
            </m.p>
          </m.div>
...
export function WomenEmpowermentSectionSkeleton() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-r from-transparent via-black/10 to-black/50" />
      <div className="relative z-10 flex min-h-[60svh] w-full items-center justify-center px-5 py-12 sm:min-h-[64svh] sm:px-6 md:min-h-[70svh] lg:h-full lg:min-h-0 lg:items-start lg:justify-end lg:px-0 lg:pt-[clamp(3.25rem,5vw,4.6rem)] lg:pr-[5vw]">
        <div className="w-full max-w-[560px] lg:w-[46vw] lg:max-w-[630px]">
