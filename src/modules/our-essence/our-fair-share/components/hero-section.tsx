...
export function OurFairShareHeroSection({ data }: OurFairShareHeroSectionProps) {
  ...
  return (
    <section className="relative min-h-[58svh] overflow-hidden bg-[#161a14] sm:min-h-[60svh] md:min-h-[68svh] lg:min-h-[100svh]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[58svh] w-full max-w-7xl items-end justify-center px-5 pt-20 pb-9 text-center sm:min-h-[60svh] sm:px-6 sm:pt-24 sm:pb-11 md:min-h-[68svh] md:pt-28 lg:min-h-[100svh] lg:max-w-none lg:items-center lg:justify-end lg:px-8 lg:pt-24 lg:pr-[5vw] lg:pb-16 2xl:px-20 2xl:pr-[6vw]">
        <div className="w-full max-w-[92vw] min-w-0 text-white sm:max-w-[500px] md:max-w-[560px] lg:w-[46vw] lg:max-w-[680px]">
          <h1 className="font-jost-extrabold text-[clamp(1rem,4.4vw,1.45rem)] leading-[1.05] text-balance text-white drop-shadow-[0_3px_16px_rgba(0,0,0,0.48)] lg:text-[clamp(2rem,2.85vw,2.7rem)]">
            {title}
          </h1>
          ...
          <p className="mx-auto mt-2 w-full max-w-[560px] text-center text-[clamp(0.55rem,2.1vw,0.72rem)] leading-relaxed text-pretty text-white/90 drop-shadow-[0_2px_10px_rgba(0,0,0,0.44)] sm:mt-3 lg:text-[clamp(0.86rem,1vw,0.98rem)]">
            {description}
          </p>
        </div>
      </div>
...
export function OurFairShareHeroSectionSkeleton() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-r from-black/14 via-black/6 to-black/28" />
      <div className="relative z-10 mx-auto flex min-h-[58svh] w-full max-w-7xl items-end justify-center px-5 pt-20 pb-9 sm:min-h-[60svh] sm:px-6 sm:pt-24 sm:pb-11 md:min-h-[68svh] md:pt-28 lg:min-h-[100svh] lg:max-w-none lg:items-center lg:justify-end lg:px-8 lg:pt-24 lg:pr-[5vw] lg:pb-16 2xl:px-20 2xl:pr-[6vw]">
