...
import type { SunflowerOilsHeroContent } from '../types';
import { defaultHeroContent } from '../data/defaults';
import { SUNFLOWER_ORANGE } from '../constants';
import { resolveCtaLink } from '@/lib/cta-link';
import { HeroBottles } from './hero-bottles';

interface Props {
  data?: SunflowerOilsHeroContent;
}

export function SunflowerOilsHero({ data }: Props) {
  const {
    logoImage,
    heading,
    subtitleLineOne,
  ...
  return (
    <section
      aria-labelledby="sunflower-hero-heading"
      ...
      style={{ backgroundColor: SUNFLOWER_ORANGE }}
    >
      {/* ============================================================
          CENTER JIVO LOGO
      ...
      >
        ...
        <div className="animate-sunflower-hero-rise">
        ...
        <div className="relative h-full w-full">
          ...
          {hasSecondBottle ? (
            <div
              ...
              className="
                animate-sunflower-bottle-throw
                pointer-events-none
                absolute
                left-[5%]
                bottom-[25%]
      ...
      >
        ...
        <a
          ...
          className="
            ...
            hover:scale-[1.04]
            hover:bg-white
            hover:text-[color:var(--sunflower-brown)]
            ...
            focus-visible:ring-offset-[color:var(--sunflower-brown)]
          ...
          "
          style={{
            ['--sunflower-brown' as string]: SUNFLOWER_ORANGE,
...
export function SunflowerOilsHeroSkeleton() {
  return (
    <section
