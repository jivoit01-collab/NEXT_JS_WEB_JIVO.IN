...
function VariantCard({
  ...
  // Bottle height grows with position; the box (card) height is unchanged.
  ...
  const inner = (
    <>
      {/* A row-spanning card is twice as wide, so its bottle is capped by vw
          rather than the column — otherwise it renders oversized. Bottom-aligned
          so the different heights share a common baseline. */}
      <div
        className={
          fullWidth
