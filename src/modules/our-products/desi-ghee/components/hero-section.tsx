...
import type { DesiGheeHeroContent } from '../types';
import { defaultHeroContent } from '../data/defaults';
import { GHEE_GREEN } from '../constants';
import { resolveCtaLink } from '@/lib/cta-link';
import { HeroBottles } from './hero-bottles';

interface Props {
  data?: DesiGheeHeroContent;
}

export function DesiGheeHero({ data }: Props) {
  const {
    logoImage,
    heading,
    subtitleLineOne,
  ...
  return (
    <section
      aria-labelledby="desi-ghee-hero-heading"
      ...
      style={{ backgroundColor: GHEE_GREEN }}
    >
      {/* ============================================================
          CENTER JIVO LOGO
      ...
      >
        ...
        <div className="animate-desi-ghee-hero-rise">
      ...
      {/* ============================================================
          ...
          viewport so the jars look like they are entering from
          the side.
        ...
        <div className="relative h-full w-full">
          ...
          {hasSecondBottle ? (
            <div
              ...
              className="
                animate-desi-ghee-bottle-throw
                pointer-events-none
                absolute
                left-[25%]
                bottom-[16%]
      ...
      >
        ...
        <a
          ...
          className="
            ...
            hover:scale-[1.04]
            hover:bg-white
            hover:text-[color:var(--ghee-green)]
            ...
            focus-visible:ring-offset-[color:var(--ghee-green)]
          ...
          "
          style={{
            ['--ghee-green' as string]: GHEE_GREEN,
...
export function DesiGheeHeroSkeleton() {
  return (
    <section
    ...
    >
      ...
      {/* Bottle composition */}
      <div
        style={{ width: 'clamp(13rem, 36vw, 65rem)', aspectRatio: '1 / 1.15' }}
        className="
          absolute
          right-0
          bottom-[4%]
