...
const SIDEBAR: NavSection[] = [
  ...
  },
  {
    ...
    icon: Package,
    children: [
      { title: 'Canola Oils', href: '/jivo-dev/our-products/canola-oils', icon: Package },
      { title: 'Groundnut Oils', href: '/jivo-dev/our-products/groundnut-oils', icon: Package },
      { title: 'Mustard Oils', href: '/jivo-dev/our-products/mustard-oils', icon: Package },
      { title: 'Olive Oils', href: '/jivo-dev/our-products/olive-oils', icon: Package },
