 ...
 * dual-graph entirely.
 *
 * The rest of the sidebar (CMS modules + SEO) is read client-side inside
 * DashboardShell from the CMS registry, which is a pure in-memory read with no
 * side effects — so only the analytics registry needs the server hand-off.
 */
