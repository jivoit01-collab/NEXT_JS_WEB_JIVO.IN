...
export default function OurFairShareAdminError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== 'production') {
      console.error('[OurFairShareAdminError]', error);
    }
  }, [error]);
  ...
  return (
    <div className="flex min-h-[40vh] items-center justify-center px-4 text-center">
      <div className="max-w-md">
        <h1 className="font-jost-bold text-2xl">Unable to load Our Fair Share editor</h1>
