...
const SECTION_PAGES: PageEntry[] = [
  // Add media pages here as you build them
];
  ...
  return (
    <div className="mx-auto max-w-5xl py-4 sm:py-8 2xl:max-w-7xl 2xl:py-10">
      ...
      <div className="mb-5 flex items-center gap-2">
        <Newspaper className="h-4 w-4" style={{ color: ACCENT }} />
      ...
      {SECTION_PAGES.length === 0 ? (
        <div className="rounded-2xl border border-dashed bg-muted/20 py-16 text-center">
          ...
          <p className="font-semibold text-muted-foreground">No media pages yet</p>
