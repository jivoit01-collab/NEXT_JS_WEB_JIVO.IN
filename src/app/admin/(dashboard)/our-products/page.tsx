...
export default function OurProductsHubPage() {
    ...
    <div className="mx-auto max-w-5xl py-4 sm:py-8">
      ...
      <div className="mb-8 text-center sm:mb-10">
        ...
        <p className="mx-auto mt-3 max-w-lg text-sm text-muted-foreground">
          Product listings, details, categories and more.
        </p>
      </div>
      ...
      {SECTION_PAGES.length === 0 ? (
        <div className="rounded-2xl border border-dashed bg-muted/20 py-16 text-center">
          ...
          <p className="font-semibold text-muted-foreground">No product pages yet</p>
